...
import { IUpdateWorkerProfileImageUseCase } from "../../../ports/worker/IUpdateWorkerProfileImageUseCase";

@injectable()
export class UpdateWorkerProfileImageUseCase implements IUpdateWorkerProfileImageUseCase{
